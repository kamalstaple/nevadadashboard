...
<section class="center-area">
    <section class="home-inner" id="statewides" data-city="{{$statewise->tab}}">
        ...
        <div class="elko-left">
            ...
            <p>Below you will find key statistics for the region you selected. Select one or more indicators from the
                summary table to access trend data. Additionally, detailed state and county-level reports are available
                and provide extensive information about the economy at all levels.</p>
        </div>
        <div class="elko-right"><a href="index"><img src="images\map_return.png"></a></div>
        <div class="clear"></div>
        ...
        <div class="indi-chart-area dn">
            ...
            <span class="chart-pop-icon download-btn"><i class="fa fa-download"></i>
                <div class="download-menu">
                    ...
                    <ul>
                        <li class="main_download_export" type="xls"><a href="javascript:void(0)">Excel Spreadsheet</a>
                        </li>
                        <li class="main_download_export" type="csv"><a href="javascript:void(0)">.csv File</a> </li>
                        <li class="chart_download" type="png"><a href="javascript:void(0)" download="Chart.png">PNG
                                File</a> </li>
                    </ul>
                </div>
            </span>
            ...
            <div class="chart-inner">
                <div id="thegrid-body" style="display: none;">
                    ...
                    <div style="border: 1px solid #AAAAAA;overflow:auto;height:355px;display:none"
                        id="thegrid_detail_div">
                ...
                <div class="chart-bar">
                    ...
                    <div class="chart-gray-bar">
                        <span id="mult-axe" style="display: none;"><input type="checkbox" id="mul-axes"> Multiple
                            Axes</span>
                    </div>
                    <div class="clr"></div>
                </div>
        ...
        <div class="elko-table">
            <table cellpadding="0" cellspacing="0" border="0">
                ...
                <tbody id="main-table-list">
                    ...
                    <tr id="row-{{$tabledata->IndicatorID}}" data-id="{{$tabledata->IndicatorID}}"
                        data-adjs="{{$tabledata->is_adjustment}}">
                        <td>
                        ...
                        <td class="location" title="{{$tabledata->GeographicAlias}}">{{$tabledata->GeographicAlias}}
                        </td>
                        ...
                        <td id="trend-{{$tabledata->IndicatorID}}" class="trend-line"
                            data-graph="{{ json_encode($tabledata->trend) }}" style="width: 100px; height: 25px;">Spark
                        </td>
