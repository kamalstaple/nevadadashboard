...
;(function($) {
	...
	var defaults = {
		...
		classes: 'tre', //classes to give the popover, i.e. normal, wider or large
		position: 'right', //where should the popover be placed? Auto, top, right, bottom, left or absolute (i.e. { top: 4 }, { left: 4 })
